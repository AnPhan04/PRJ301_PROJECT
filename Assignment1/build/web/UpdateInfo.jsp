...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="icon1">
                            ...
                            <div class="modal">
                                ...
                                <div class="auth-form__aside2">
                                    <p class="auth-form__login">Bạn mới biết đến Bitis?  <a href="DangKi.html" class="auth-form__login">Đăng ký</a></p>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row uh_3">
                <div class="col-xl-3 uh_3_trai update">
                    <div class="avataruser">
                        ${sessionScope.viettat}
                    </div>
                    <div class="tenuser">Xin chào <b>${sessionScope.hoten}</b></div>
                ...
                <div class="col-xl-6 uh_3_phai update">
                    <div class="thongtin_phai3">
                        <b class="update" style="margin-bottom: 10px;display: block;">THÔNG TIN TÀI KHOẢN</b>
                        <form action="Register" method="get" accept-charset="utf-8" class="update">
                            <p class="input">
                                Họ:<br>
                                <input type="text" name="ho" placeholder="Họ" value="${sessionScope.u.ho}">
                            </p> 
                            <p class="input"> 
                                Tên:<br>
                                <input type="text" name="ten" placeholder="Tên" value="${sessionScope.u.ten}">
                            </p> 
                            <p class="input">
                                Email:<br>
                                <input type="email" name="username" placeholder="Email" value="${sessionScope.u.userName}">
                            </p>
                            <p class="input">
                                Số Điện Thoại:<br>
                                <input type="text" name="sdt" placeholder="Số điện thoại (*)" value="${sessionScope.u.sdt}">
                            </p>

                            <p class="input">
                                Ngày sinh:<br>
                                <input type="date" name="ngaysinh" value="${sessionScope.u.DOB}">
                            </p> 
                            <p class="input">
                                Địa Chỉ:<br>
                                <input type="text" name="address" placeholder="Địa Chỉ" value="${sessionScope.u.address}">
                            </p>

                             <input type="hidden" name="do" value="capnhat">
                             <input type="hidden" name="userID" value="${sessionScope.u.userId}"> 
                             <p style="text-align: center;color: red;font-size: 20px;font-weight: bold">${requestScope.trangthai}</p>
                            <div class="submit_wrapper update">
                                <div class="submit">
                                    <button class="update" type="submit">Cập nhật thông tin</button>
                                </div>
