<%-- 
    Document   : GiaoHang
    Created on : Mar 16, 2023, 4:55:16 PM
    Author     : ASUS
--%>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="Nam.html" id="navbarDropdownMenuLink" role="button" aria-expanded="false">NAM
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="Nu.html" id="navbarDropdownMenuLink" role="button" aria-expanded="false">NỮ
                                <i class="fa fa-chevron-down"></i>
                                <div class="thanhchay"></div>
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <div class="col-xl-5 ">
                    ...
                    <form action="Orders" method="get" accept-charset="utf-8">
                        <p class="input">Họ và tên:<br>
                            <input type="text" name="hovaten" placeholder="Họ và tên" value="${sessionScope.hoten}">
                        </p> 
                        <p class="input">Email:<br>
                            <input type="email" name="email" placeholder="Email"  value="${sessionScope.u.userName}">
                        </p> 
                        ...
                        <p class="input">Địa chỉ:<br>
                            <input type="text" name="diachi" placeholder="Đại chỉ" value="${sessionScope.u.address}">
                        </p>
                        <p class="input">Xã:<br>
                        ...
                        <div class="submit_wrapper">
                            ...
                            <div class="text"  style="padding-top: 15px;">Bạn đã có tài khoản ? 
