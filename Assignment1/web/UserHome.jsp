            ...
            <div class="row uh_3">
                ...
                <div class="col-xl-9 uh_3_phai">
                    <div class="thongtin_phai3">
                        <b style="margin-bottom: 10px;display: block;">THÔNG TIN TÀI KHOẢN</b>
                        <p >Họ và tên: <b >${sessionScope.hoten}</b></p>
                        <p >Email: <b >${sessionScope.u.userName}</b></p>
                        <p>Địa chỉ: <b >${sessionScope.u.address}</b></p>
                        <p >Ngày sinh: <b >${sessionScope.u.DOB}</b></p>
                        <p>Điện thoại: <b>${sessionScope.u.sdt}</b></p>
                    </div>  
                    <a  href="UpdateInfo.jsp" class="capnhatthongtin">
